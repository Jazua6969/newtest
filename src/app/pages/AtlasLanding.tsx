    ...
    <div style={{ background: 'var(--canvas-bone)', fontFamily: 'var(--font-ui)' }}>
      ...
      <section className="pt-24 pb-20 px-6 lg:px-8" style={{ background: 'var(--abyss-ink)' }}>
        <div className="max-w-5xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-medium mb-8 border" style={{ background: 'rgba(212,175,55,0.1)', borderColor: 'rgba(212,175,55,0.2)', color: 'var(--meridian-gold)' }}>
            <span className="w-1.5 h-1.5 rounded-full bg-current animate-pulse" />
            Atlas v2.1 — Implementation Intelligence
          </div>
